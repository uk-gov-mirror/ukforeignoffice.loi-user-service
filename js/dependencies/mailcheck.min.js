/*! mailcheck v1.1.1 @licence MIT */ var Mailcheck = {
  domainThreshold: 2,
  ...
  suggest: function (a, b, c, d, e) {
    ...
    if (f.domain) {
      ...
      if (
        ...
        i && i != f.topLevelDomain && ((g = g.replace(f.topLevelDomain, i)), (j = !0)),
        1 == j)
      )
...
'undefined' != typeof module && module.exports && (module.exports = Mailcheck),
  'function' == typeof define && define.amd && define('mailcheck', [], () => Mailcheck),
