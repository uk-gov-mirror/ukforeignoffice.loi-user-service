...
!((e, t) => {
  ...
  ;(S.fn = S.prototype =
    ...
    S.each('Boolean Number String Function Array Date RegExp Object Error Symbol'.split(' '), (e, t) => {
  ...
  var d = ((n) => {
    var e,
      ...
      ie = (e, t) =>
        t ? ('\0' === e ? '\ufffd' : e.slice(0, -1) + '\\' + e.charCodeAt(e.length - 1).toString(16) + ' ') : '\\' + e,
      oe = () => {
        T()
      },
      ...
      (e) => {
        ...
        return (
          r != C &&
            ...
            (d.getById = ce(
              (e) => ((a.appendChild(e).id = S), !C.getElementsByName || !C.getElementsByName(S).length),
            )),
            d.getById
              ? ((b.filter.ID = (e) => {
    ...
    ((b = se.selectors =
      {
        ...
        pseudos: {
          ...
          contains: le((t) => ((t = t.replace(te, ne)), (e) => -1 < (e.textContent || o(e)).indexOf(t))),
          lang: le(
            (n) => (
          ...
          root: (e) => e === a,
          focus: (e) => e === C.activeElement && (!C.hasFocus || C.hasFocus()) && !!(e.type || e.href || ~e.tabIndex),
          enabled: ge(!1),
          disabled: ge(!0),
          checked: (e) => {
            var t = e.nodeName.toLowerCase()
  ...
  var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    oe = { composed: !0 }
  re.getRootNode && (ie = (e) => S.contains(e.ownerDocument, e) || e.getRootNode(oe) === e.ownerDocument)
  var ae = (e, t) =>
  ...
  S.extend({
      ...
      if (t)
        return (
          (parseFloat(Be(e, 'marginLeft')) ||
            e.getBoundingClientRect().left - We(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)) + 'px'
        )
    })),
    ...
    (S.easing = { linear: (e) => e, swing: (e) => 0.5 - Math.cos(e * Math.PI) / 2, _default: 'swing' }),
  ...
  S.fn.extend({
    ...
    (pt = { set: (e, t, n) => (!1 === t ? S.removeAttr(e, n) : e.setAttribute(n, n), n) }),
  ...
  S.fn.extend({
    ...
    S.each(['radio', 'checkbox'], function () {
      ;(S.valHooks[this] = {
        ...
        y.checkOn || (S.valHooks[this].get = (e) => (null === e.getAttribute('value') ? 'on' : e.value))
    }),
        ...
        return this.map(function () {
          ...
          .map(function (e, t) {
            ...
            return null == n
              ? null
              : Array.isArray(n)
                ? S.map(n, (e) => ({ name: t.name, value: e.replace(kt, '\r\n') }))
  ...
  ;(Wt.href = Tt.href),
    S.extend({
      ...
      ajaxSetup: (e, t) => (t ? $t($t(e, S.ajaxSettings), t) : $t(S.ajaxSettings, e)),
      ajaxPrefilter: Ft(Rt),
      ajaxTransport: Ft(Mt),
      ajax: (e, t) => {
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            !i && -1 < S.inArray('script', v.dataTypes) && (v.converters['text script'] = () => {}),
            (s = ((e, t, n, r) => {
              var i,
                o,
                a,
    ...
    (S.expr.pseudos.visible = (e) => !!(e.offsetWidth || e.offsetHeight || e.getClientRects().length)),
    (S.ajaxSettings.xhr = () => {
      try {
  ...
  S.ajaxSetup({
    ...
    S.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (e, t) => {
      S.fn[t] = function (e) {
        return this.on(t, e)
      }
    }),
  ...
  var Yt = C.jQuery,
    Qt = C.$
  return (
    (S.noConflict = (e) => (C.$ === S && (C.$ = Qt), e && C.jQuery === S && (C.jQuery = Yt), S)),
