...
;((root) => {
  ...
  */
  window.GOVUK.cookie = (name, value, options) => {
  ...
  window.GOVUK.savePreferencesSelected = () => {
  ...
  window.GOVUK.hideConfirmationBanner = () => {
    var confirmation_message = document.getElementById('confirmation-cookie-message')
    confirmation_message.style.display = 'none'
    window.GOVUK.cookie('cookies_preferences_set', 'true', { days: 365 })
  }

  window.GOVUK.getConsentCookie = () => {
  ...
  window.GOVUK.checkConsentCookieCategory = (cookieName, cookieCategory) => {
  ...
  window.GOVUK.checkConsentCookie = (cookieName, cookieValue) => {
  ...
  window.GOVUK.setCookie = (name, value, options) => {
  ...
  window.GOVUK.getCookieCategory = (cookie) => COOKIE_CATEGORIES[cookie]

  window.GOVUK.disableMatomo = (currentConsent) => {
