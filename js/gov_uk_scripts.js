function ShowHideContent() {
  ...
  self.escapeElementName = (str) => {
    result = str.replace('[', '\\[').replace(']', '\\]')
    return result
  }

  self.showHideRadioToggledContent = () => {
    $('input.govuk-radios__input[type=radio]').each(function () {
      ...
      if (dataTarget) {
        ...
        $radio.on('click', () => {
          ...
          $radio
            .closest('form')
            .find('input.govuk-radios__input[name=' + self.escapeElementName($radioGroupName) + ']')
            .each(function () {
              var $this = $(this)
  ...
  self.showHideCheckboxToggledContent = () => {
...
GOVUK.performance.sendGoogleAnalyticsEvent = (category, event, label) => {
